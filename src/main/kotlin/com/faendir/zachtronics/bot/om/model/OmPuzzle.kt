...
enum class OmPuzzle(
    ...
    // HORN_SILVER(WEEKLIES_2021, NORMAL, "Horn Silver", "w2513871683", "OM2021Demo_HornSilver"),
    COLVAN_BLUE(WEEKLIES_2021, NORMAL, "Colvan Blue", "w2518202582", "OM2021Demo_ColvanBlue"),
    SUPERCONDUCTIVE_COPPER(WEEKLIES_2021, POLYMER_HEIGHT, "Superconductive Copper", "w2524954452", "OM2021Demo_SuperconductiveCopper"),
    ARQUERITE_PROMOTION(WEEKLIES_2021, NORMAL, "Arquerite Promotion", "w2532208444", "OM2021Demo_ArqueritePromotion"),
    // GREEN_VITRIOL(WEEKLIES_2021, NORMAL, "Green Vitriol", "w2539581468", "OM2021Demo_GreenVitriol"),
    CRYSTAL_COMPRESSION(WEEKLIES_2021, NORMAL, "Crystal Compression", "w2549376052", "OM2021Demo_CrystalCompression"),
    CRANBERRY_GLASS(WEEKLIES_2021, NORMAL, "Cranberry Glass", "w2552978793", "OM2021Demo_CranberryGlass"),
    CRIMSON_CRYSTAL_BISECTION(WEEKLIES_2021, NORMAL, "Crimson Crystal Bisection", "w2559171862", "OM2021Demo_CrimsonCrystalBisection"),
    // FERROUS_WHEEL(WEEKLIES_2021, NORMAL, "Ferrous Wheel", "w2565611826", "OM2021Demo_FerrousWheel"),
    VAPORIZED_PROPELLANT(WEEKLIES_2021, NORMAL, "Vaporized Propellant", "w2571785927", "OM2021Demo_VaporizedPropellant"),
    EXPLOSIVE_FINGER_TRAP(WEEKLIES_2021, NORMAL, "Explosive Finger Trap", "w2577937621", "OM2021Demo_ExplosiveFingerTrap"),
    QUINTESSENTIAL_CATALYST(WEEKLIES_2021, NORMAL, "Quintessential Catalyst", "w2584226376", "OM2021Demo_QuintessentialCatalyst"),
    // ARTIFICIAL_ORE(WEEKLIES_2021, PRODUCTION, "Artificial Ore", "w2591419339", "OM2021Demo_ArtificialOre"),
    STABILIZED_EVERYTHING(WEEKLIES_2021, NORMAL, "Stabilized Everything", "w2597770395", "OM2021Demo_StabilizedEverything"),

    SWEEPER_ROD(WEEKLIES_2022, POLYMER_HEIGHT, "Sweeper Rod", "w2827094903", "OM2022Weeklies_SweeperRod"),
    // MARTIAL_REGULUS(WEEKLIES_2022, NORMAL, "Martial Regulus", "w2827119474", "OM2022Weeklies_MartialRegulus"),
    // PHILOSOPHER_S_CATALYST(WEEKLIES_2022, NORMAL, "Philosopher's Catalyst", "w2868339730", "OM2022Weeklies_PhilosophersCatalyst"),
    // NIGHTMARE_FUEL(WEEKLIES_2022, NORMAL, "Nightmare Fuel", "w2829050875", "OM2022Weeklies_NightmareFuel"),
    // IGNITION_CORD(WEEKLIES_2022, POLYMER_HEIGHT, "Ignition Cord", "w2839120106", "OM2022Weeklies_IgnitionCord"),
    SERVIN_S_WHEEL(WEEKLIES_2022, NORMAL, "Servin's Wheel", "w2868506869", "OM2022Weeklies_ServinsWheel"),
    // CUPRITE(WEEKLIES_2022, NORMAL, "Cuprite", "w2868328394", "OM2022Weeklies_Cuprite"),
    SUSPICIOUSLY_STABLE_SUBSTANCE(WEEKLIES_2022, NORMAL, "Suspiciously Stable Substance", "w2868337187", "OM2022Weeklies_SuspiciouslyStable"),
    // LUSTROUS_SYRUP(WEEKLIES_2022, NORMAL, "Lustrous Syrup", "w2868331650", "OM2022Weeklies_LustrousSyrup"),
    ...
    DYE_HARD(WEEKLIES_2023, NORMAL, "Dye Hard", "OM2023Weeklies_DyeHard"),
    // TONIC_OF_TRANSMOGRIFICATION(WEEKLIES_2023, VARIABLE_NORMAL, "Tonic of Transmogrification", "OM2023Weeklies_TransTonic"),
    RING_ENLARGEMENT(WEEKLIES_2023, NORMAL, "Ring Enlargement", "w3087959475", "OM2023Weeklies_RingEnlargement"),
    BLACK_POWDER(WEEKLIES_2023, NORMAL, "Black Powder", "w3088257476", "OM2023Weeklies_BlackPowder"),
    EYEDROPS_OF_IRRITATION(WEEKLIES_2023, NORMAL, "Eyedrops Of Irritation", "OM2023Weeklies_EyedropsOfIrritation"),
    HEXSTABILIZED_TEULING_S_MORS(WEEKLIES_2023, NORMAL, "Hexstabilized Teuling's Mors", "w2938303257", "OM2023Weeklies_HexstabilizedTeulingsMors"),
    VISCOUS_ADHESIVE(WEEKLIES_2023, NORMAL, "Viscous Adhesive", "OM2023Weeklies_ViscousAdhesive"),
    // PARTICLE_RECONSTRUCTION(WEEKLIES_2023, COMPUTATION_PRODUCTION, "Particle Reconstruction", "OM2023Weeklies_ParticleReconstruction"),
    // DARK_MATTER_CANDIDATE(WEEKLIES_2023, NORMAL, "Dark Matter Candidate", "w3098794818", "OM2023Weeklies_DarkMatterCandidate"),
    QUINTESSENTIAL_EXPLOSIVE(WEEKLIES_2023, NORMAL, "Quintessential Explosive", "w3049655429", "OM2023Weeklies_QuintessentialExplosive"),
    VACCINE_TEMPLATE(WEEKLIES_2023, PRODUCTION, "Vaccine Template", "w3033141056", "OM2023Weeklies_VaccineTemplate"),
    SALT_PACKAGING_FACTORY(WEEKLIES_2023, NORMAL, "Salt Packaging Factory", "OM2023Weeklies_SaltPackagingFactory"),

    PITCH_DROP_EXPERIMENT(WEEKLIES_2024, PRODUCTION, "Pitch Drop Experiment", "w3289331276", "OM2024Weeklies_PitchDropExperiment"),
    // PALATABLE_TISSUE(WEEKLIES_2024, POLYMER_HEIGHT, "Palatable Tissue", "OM2024Weeklies_PalatableTissue"),
    INSTANT_MIRROR_COAT(WEEKLIES_2024, NORMAL, "Instant Mirror Coat", "OM2024Weeklies_InstantMirrorCoat"),
    DEEP_FRIED_ROCKET_PROPELLANT(WEEKLIES_2024, NORMAL, "Deep-Fried Rocket Propellant", "w3288812964", "OM2024Weeklies_DeepFriedRocketPropellant"),
    DEEP_FRIED_UNSTABLE_COMPOUND(WEEKLIES_2024, NORMAL, "Deep-Fried Unstable Compound", "w3288813162", "OM2024Weeklies_BSides_DeepFriedUnstableCompound"),
    // SOPHICK_MERCURY(WEEKLIES_2024, NORMAL, "Sophick Mercury", "OM2024Weeklies_SophickMercury"),
    RETRO_REFINING(WEEKLIES_2024, PRODUCTION, "Retro Refining", "w3297760188", "OM2024Weeklies_RetroRefining"),
    BREATHABLE_FLUID(WEEKLIES_2024, NORMAL, "Breathable Fluid", "w3303849741", "OM2024Weeklies_BreathableFluid"),
    // LOOK_AND_SAY(WEEKLIES_2024, COMPUTATION_NORMAL, "Look-And-Say", "OM2024Weeklies_LookAndSay"),
    ORNAMENTAL_PLATING(WEEKLIES_2024, NORMAL, "Ornamental Plating", "OM2024Weeklies_OrnamentalPlating"),
    FAERO_FILAMENT(WEEKLIES_2024, POLYMER_HEIGHT, "Faero Filament", "OM2024Weeklies_FaeroFilament"),
    UNSTABLE_SOVRIUM(WEEKLIES_2024, PRODUCTION, "Unstable Sovrium", "w3324143489", "OM2024Weeklies_UnstableSovrium"),
    TOUCH_GRASS(WEEKLIES_2024, POLYMER_HEIGHT, "Touch Grass", "OM2024Weeklies_TouchGrass"),

    JEWEL_BOX(WEEKLIES_2025, PRODUCTION, "Jewel Box", "Weeklies2025_JewelBox_v2", "Weeklies2025_JewelBox"),
    SAND_OF_SUSPENSION(WEEKLIES_2025, NORMAL, "Sand of Suspension", "w3584964665", "Weeklies2025_SandOfSuspension"),
    THERMITE_TAPE(WEEKLIES_2025, POLYMER_HEIGHT, "Thermite Tape", "w3584943609", "Weeklies2025_ThermiteTape"),
    PARETO_POPPERS(WEEKLIES_2025, NORMAL, "Pareto Poppers", "w3584642234", "Weeklies2025_ParetoPoppers"),
    SMOG_NEUTRALIZATION(WEEKLIES_2025, NORMAL, "Smog Neutralization", "w3584644954", "Weeklies2025_SmogNeutralization"),
    ASBESTOS(WEEKLIES_2025, PRODUCTION, "Asbestos", "w3584699215", "Weeklies2025_Asbestos"),
    RAVARI_S_ROAD(WEEKLIES_2025, NORMAL, "Ravari's Road", "w3584639567", "Weeklies2025_RavarisRoad"),
    // BOOZESORT(WEEKLIES_2025, COMPUTATION_NORMAL, "Boozesort", "w3586591950", "Weeklies2025_Boozesort"),
    NYLON(WEEKLIES_2025, POLYMER_HEIGHT, "Nylon", "Weeklies2025_Nylon"),
    RECIPE_FOR_DISASTER(WEEKLIES_2025, NORMAL, "Recipe for Disaster", "w3585103923", "Weeklies2025_RecipeForDisaster"),
    MOONLIGHT_CATALYST(WEEKLIES_2025, NORMAL, "Moonlight Catalyst", "Weeklies2025_Moonlight_Catalyst"),
    // UNNAMED_CUSTOM_PUZZLE(WEEKLIES_2025, VARIABLE_NORMAL, "Unnamed Custom Puzzle", "OM2025Weeklies12"),

    LIQUID_PERFUMES(WEEKLIES_2026, NORMAL, "Liquid Perfumes", "weeklies2026_liquid-perfumes"),
    DOWSING_RODS(WEEKLIES_2026, POLYMER_HEIGHT, "Dowsing Rods", "weeklies2026_dowsing-rods"),
    ...
    UNIVERSAL_PLASTER(SPEEDSOLVE_1, NORMAL, "Universal Plaster", "w2996030860", "c233452097149833"),
    COMPRESSED_SOIL(SPEEDSOLVE_1, NORMAL, "Compressed Soil", "w2996031515", "c465778471196537"),
    THINGS_I_WON_T_WORK_WITH(SPEEDSOLVE_1, NORMAL, "Things I Won't Work With", "w2680445697", "c357083080732221"),
    VAPOROUS_SOLVENT_TO_STAIN_REMOVER(SPEEDSOLVE_1, NORMAL, "Vaporous Solvent to Stain Remover", "w2996032478", "c000592242400880"),

    LOGISTICS(SPEEDSOLVE_2, PRODUCTION, "Logistics", "w2818265313", "SpeedSolve-2.1-Logistics"),
    CANCER_MEDICINE(SPEEDSOLVE_2, NORMAL, "Cancer Medicine", "w2812085422", "Speedsolve-2.2-cancer-medicine"),
    EPHEMERAL_MATRIX(SPEEDSOLVE_2, NORMAL, "Ephemeral Matrix", "w2817998770", "Speedsolve-2.3-Ephemeral-Matrix"),
    POUSSE_CAFE(SPEEDSOLVE_2, NORMAL, "Pousse-Café", "w2871131950", "c826594300995707"),
    CUQUERITE_PROMOTION(SPEEDSOLVE_2, NORMAL, "Cuquerite Promotion", "w2996034340", "SpeedSolve-2.5-CuqueritePromotion"),
    IN_LOCO_DISPONO(SPEEDSOLVE_2, NORMAL, "In Loco Dispono", "w2996036455", "SpeedSolve-2.6-in-loco-dispono"),

    SCRAP_METAL(SPEEDSOLVE_3, NORMAL, "Scrap Metal", "w3087853677", "scrap-metal"),
    BERLO_S_DUALISM(SPEEDSOLVE_3, NORMAL, "Berlo's Dualism", "w3087856277", "berlos-dualism"),
    DESTABILIZED_NATURE(SPEEDSOLVE_3, NORMAL, "Destabilized Nature", "w3087858504", "destabilized-nature"),
    ...
    // LAMBENT_LXVII(TRIXIE, VARIABLE_NORMAL, "Lambent LXVII", "c589658269721779"),
