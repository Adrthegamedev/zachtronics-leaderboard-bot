...
enum class OmCategory(
    ...
    GR(INFINITY_AREA, NOVERLAP, COST, RATE, AREA_INF, displayName = "GR"),
    GR_P(INFINITY_PROD, NOVERLAP, COST, RATE, INSTRUCTIONS, displayName = "GR"), 
    AR(INFINITY_AREA, NOVERLAP, AREA_INF, RATE, COST, displayName = "AR"),
    IR(INFINITY_AREA, NOVERLAP, INSTRUCTIONS, RATE, COST, AREA_INF, displayName = "IR"),
    IR_P(INFINITY_PROD, NOVERLAP, INSTRUCTIONS, RATE, COST, displayName = "IR"),
